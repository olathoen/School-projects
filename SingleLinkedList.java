public class SingleLinkedList {//LinkedList class
    ...
    public SingleLinkedList() {//LinkedList default constructor
    ...
    public void insert17(int x) {

        Node current = head;

        if (x < 0)
            System.out.println("Vennligst velg et positivt heltall");
        ...
        if (elementCount == 0) {
            ...
            while (current.next != null) {
                ...
                if (current.next.value < x) {
                    ...
                    current.next.next = new Node(x, current.next.next.next);
    ...
    public int delete18(int x) {

        if (head == null) {
            System.out.println("Lista er tom!");
        }

        if (head.value == x && elementCount == 1) {
